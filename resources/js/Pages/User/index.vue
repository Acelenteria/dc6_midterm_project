    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="flex mt-5 mb-2">
                ...
                <!--THIS IS FOR LINK TO CREATE USER
                     href="users/create" v-if="$page.props.auth.permissions.includes('create-product')" -->
                <Link style="margin-left:1245px" class="btn-primary items-center mr-20 px-3 py-3 bg-blue-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-600 focus:bg-blue-600 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Create User</Link>
            </div>
