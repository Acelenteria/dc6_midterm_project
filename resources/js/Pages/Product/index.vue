            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex justify-between mt-5">
                        ...
                        <Link style="margin-left:1120px" href="products/create" v-if="$page.props.auth.permissions.includes('create-product')" class="btn-primary items-center mr-20 px-2 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-600 focus:bg-blue-600 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            Create</Link>
                    </div>
                    <!-- component -->
                    <div :class="themeMode">
